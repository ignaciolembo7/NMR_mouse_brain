...
for roi, color in zip(rois,palette):
    ...
    model = lmfit.Model(nogse.contrast_vs_g_intrarest_extrarestdist, independent_vars=["TE", "G", "N"], param_names=["l_c_int", "l_c_mode_ext", "sigma_ext", "M0_int", "M0_ext", "D0_int", "D0_ext"])
    model.set_param_hint("M0_int", value=21.0, min = 12.0, max = 30.0)
    model.set_param_hint("M0_ext", value=21.0, min = 12.0, max = 30.0)
    model.set_param_hint("l_c_int", value= 98, min = 0.1, max = 100.0)
    model.set_param_hint("l_c_mode_ext", value= 1.6, min = 0.1, max = 2.0)  
    model.set_param_hint("sigma_ext", value= 0.35, min = 0.1, max = 1.4)
    ...
    fit = nogse.contrast_vs_g_intrarest_extrarestdist(float(tnogse), g_fit, n, l_c_int_fit, l_c_mode_ext_fit, sigma_ext_fit, M0_int_fit, M0_ext_fit, D0_int_fit, D0_ext_fit)
    fit_int = nogse.contrast_vs_g_rest(float(tnogse), g_fit, n, l_c_int_fit, M0_int_fit, D0_int_fit)
