...
directory = f"../results_{file_name}/{folder}/slice={slic}/tnogse={tnogse}_g={g}_N={int(n)}_id={id}"
...
for roi, color in tqdm(zip(rois,palette)):
    ...
    nogse.plot_nogse_vs_x_restdist(ax, roi, modelo, x, x_fit, f, fit, tnogse, n, slic, color)
    nogse.plot_nogse_vs_x_restdist(ax1, roi, modelo, x, x_fit, f, fit, tnogse, n, slic, color)
    ...
    nogse.plot_lognorm_dist(ax3, roi, tnogse, n, l_c, l_c_fit, sigma_fit, slic, color)
