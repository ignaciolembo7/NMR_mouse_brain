...
for roi, g in zip(rois,gs): 
    ...
    ax1.plot(grad, t_c, 'o-', markersize=7, linewidth=2, label=label)
    ...
    ax2.plot(grad, t_c, 'o-', markersize=7, linewidth=2, label=label)
...
fig2.tight_layout()
fig2.savefig(f"{directory}/tauc_vs_g_allROI.png", dpi=600)
fig2.savefig(f"{directory}/tauc_vs_g_allROI.pdf")